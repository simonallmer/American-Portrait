...
// Initial run if already on the page
if (window.location.hash === '#african-pyramid') {
    window.initPyramid();
}


function initializeUI() {
    const menuToggle = document.getElementById('pyramid-menu-toggle');
    const sideMenu = document.getElementById('pyramid-side-menu');
    const newGameBtn = document.getElementById('pyramid-new-game-btn');
    const playerCountBtn = document.getElementById('pyramid-player-count-btn');
    playerCountBtn.textContent = `Players: ${playerCount}`;
    updatePlayerCountUI();
    const opponentBtn = document.getElementById('pyramid-opponent-btn');
    const rulesBtn = document.getElementById('pyramid-rules-btn');
    const closeRulesBtn = document.getElementById('pyramid-close-rules-btn');
    const closeRulesBtnBottom = document.getElementById('pyramid-close-rules-btn-bottom');
    const rulesOverlay = document.getElementById('pyramid-rules-overlay');
    const rulesModal = document.getElementById('pyramid-rules-modal');
    const playAgainBtn = document.getElementById('pyramid-play-again-btn');
    const viewToggleBtn = document.getElementById('pyramid-view-toggle-btn');
    const closeFromMenuBtn = document.getElementById('pyramid-close-from-menu-btn');
    ...
    playAgainBtn.addEventListener('click', () => {
        document.getElementById('pyramid-game-over-overlay').classList.add('hidden');
        initializePyramid();
        if (view3D) view3D.updateStones();
        if (view2D) view2D.draw();
    });
...
function updateViewMode() {
    ...
    const viewToggleBtn = document.getElementById('pyramid-view-toggle-btn');
    const canvas3d = document.getElementById('pyramid-canvas-3d');
    const canvas2d = document.getElementById('pyramid-canvas-2d');
...
function initializeViews() {
    const container3d = document.getElementById('pyramid-canvas-3d');
    const container2d = document.getElementById('pyramid-canvas-2d');
...
function updateUI() {
    ...
    const playerIndicator = document.getElementById('pyramid-player-indicator');
    const playerName = document.getElementById('pyramid-player-name');
    const whiteCount = document.getElementById('pyramid-white-count');
    const blackCount = document.getElementById('pyramid-black-count');
    const redCount = document.getElementById('pyramid-red-count');
    const blueCount = document.getElementById('pyramid-blue-count');
    const topCount = document.getElementById('pyramid-top-count');
...
function showGameOver(title, text) {
    const overlay = document.getElementById('pyramid-game-over-overlay');
    const titleEl = document.getElementById('pyramid-game-over-title');
    const textEl = document.getElementById('pyramid-game-over-text');
...
function showMessage(text) {
    const msgBox = document.getElementById('pyramid-game-message');
